(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('http'), require('https'), require('url'), require('assert'), require('stream'), require('tty'), require('util'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['http', 'https', 'url', 'assert', 'stream', 'tty', 'util', 'zlib'], factory) :
  (global = global || self, global.track = factory(global.http, global.https, global.url, global.assert, global.stream, global.tty, global.util, global.zlib));
}(this, (function (http, https, url, assert, stream, tty, util, zlib) { 'use strict';
  ...
  var _spec = "axios";
  var _where = "/Users/sameer/code/gitthub/track";
  var author = {
  	name: "Matt Zabriskie"
  };
  var browser$1 = {

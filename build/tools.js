 ...
 * @returns Loader
 */
exports.createTsParseUseLoader = function createTsParseUseLoader(
  loader,
  tsConfig
) {
  switch (loader) {
 ...
 */
exports.tsLoaderConfigMerge = function tsLoaderConfigMerge(
  tsconfg,
  tsloaderConfig,
  projectConfig
) {
  // let tsConfOfProj = Object.assign({},projectConfig.tsconfig);
  let tsConfOfProj = Object.assignExcludeKeys(
    {},
    ["loader"],
    projectConfig.tsconfig
  );
  return uniqMerge(
    { compilerOptions: tsconfg.compilerOptions },
    tsloaderConfig,
    { compilerOptions: tsConfOfProj }
  );
};
 ...
 */
exports.projecConfigMultipleTargetsSeparation = function projecConfigMultipleTargetsSeparation(
  projectConfig
) {
